...
const applicationId = typeof import.meta.env.VITE_APP_ID === "string" ? import.meta.env.VITE_APP_ID : ''
const secret = typeof import.meta.env.VITE_SECRET === "string" ? import.meta.env.VITE_SECRET : ''
...
const myVideo = ref<LocalVideoStream>()
const myAudio = ref<LocalAudioStream>()

const localVideo = ref<HTMLVideoElement>()
const remoteVideoArea = ref()
const remoteAudioArea = ref()
...
const join = async () => {
  ...
  // 自分の映像と音声を公開する
  if (myVideo.value && myAudio.value) {
